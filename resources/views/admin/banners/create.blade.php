...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold">Créer une Bannière</h1>
    </div>

    <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#5a7c6f] focus:border-transparent">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <select name="type" id="type"
                    ...
                    <option value="promotional" {{ old('type') === 'promotional' ? 'selected' : '' }}>Promotionnel</option>
            ...
            <div>
                ...
                <select name="position" id="position"
                    ...
                    <option value="home_slider" {{ old('position') === 'home_slider' ? 'selected' : '' }}>Slider Principal</option>
                    <option value="home_top" {{ old('position') === 'home_top' ? 'selected' : '' }}>Haut de Page</option>
                    <option value="home_middle" {{ old('position') === 'home_middle' ? 'selected' : '' }}>Milieu de Page</option>
                    <option value="home_bottom" {{ old('position') === 'home_bottom' ? 'selected' : '' }}>Bas de Page</option>
